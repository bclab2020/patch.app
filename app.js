    ...
    "soccer": {
        ...
        "points": [
            ...
            },
            {
                ...
                "y": 168,
                "name": "腰方形筋 (QL) 周囲 (右)",
                "desc": "一番下の肋骨と骨盤の骨の縁（腸骨稜）のちょうど中間、背骨から外側に指4本分の脇腹。骨盤の左右ブレを抑え軸を安定。",
                "view": "back"
            },
            {
                "x": 120,
            ...
            },
            {
                ...
                "y": 199,
                "name": "大腿四頭筋起始部 (右)",
                "desc": "骨盤の前面の出っ張り（上前腸骨棘）から真下に指3本分、太も目の付け根中央。キックのテイクバック可動域を拡大。",
                "view": "front"
            },
            {
                "x": 122,
        ...
        "points": [
            {
                ...
                "y": 80,
                "name": "鎖骨下周囲 (右)",
                "desc": "鎖骨の外側1/3（肩側の先端近く）のすぐ下にあるくぼみ（中央から指2〜3本分外側）。巻き肩をリセットし、胸郭の開きを拡大。",
                "view": "front"
            },
            {
                "x": 118,
            ...
            },
            {
                ...
                "y": 84,
                "name": "棘上筋・棘下筋起始部 (右)",
                "desc": "肩甲骨の斜めに走る出っ張り骨の上側のくぼみ（棘上筋）と、そのすぐ下側の肩甲骨中央（棘下筋）。肩関節の衝突痛を防止し可動域拡大。",
                "view": "back"
            },
            {
                "x": 115,
            ...
            },
            {
                ...
                "y": 178,
                "name": "多裂筋起始部 (右)",
                "desc": "腰の背骨（腰椎）の突起のすぐきわ（指半本分外側）、骨盤中央（仙骨）のすぐ上の高さ。投球・打撃のスイング回旋軸のブレを抑制。",
                "view": "back"
            },
            {
                "x": 113,
    ...
    "golf": {
        ...
        "points": [
            ...
            },
            {
                ...
                "y": 183,
                "name": "手関節背側 (右)",
                "desc": "手首の甲側のしわの中央から指1.5本分肘寄り、骨の間のくぼみ。インパクト時の手首のこね（アーリーリリース）を防止。",
                "view": "front"
            },
            {
                "x": 164,
        ...
        "points": [
            {
                ...
                "y": 140,
                "name": "外側上顆周囲 (右)",
                "desc": "肘の外側の骨の出っ張り（外側上顆）から指1.5本分前腕（手首）寄りの筋肉 of ふくらみ。テニス肘の予防に効果的。",
                "view": "front"
            },
            {
                "x": 155,
            ...
            },
            {
                ...
                "y": 80,
                "name": "鎖骨下周囲 (右)",
                "desc": "鎖骨の外側1/3のすぐ下にあるくぼみ（中央から指2〜3本分外側）。胸郭の回旋を促し、手打ちを防いで体幹でストローク。",
                "view": "front"
            },
            {
                "x": 118,
        ...
        "points": [
            {
                ...
                "y": 290,
                "name": "膝蓋骨周囲 (右)",
                "desc": "お皿（膝蓋骨）の下縁中央から左右外側へ指1本分。ジャンパー膝を防ぎ、着地の内反（ニーイン）を抑える。",
                "view": "front"
            },
            {
                "x": 124,
        ...
        "points": [
            {
                ...
                "y": 80,
                "name": "鎖骨下周囲 (右)",
                "desc": "鎖骨の外側1/3（肩側の先端近く）のすぐ下にあるくぼみ（中央から指2〜3本分外側）。腕のスムーズな回旋を促す。",
                "view": "front"
            },
            {
                "x": 118,
            ...
            },
            {
                ...
                "y": 85,
                "name": "棘上筋・棘下筋起始部 (右)",
                "desc": "肩甲骨の斜めに走る出っ張り骨の上側のくぼみ（棘上筋）と、そのすぐ下側の肩甲骨中央（棘下筋）。プル動作における肩甲骨の協調性向上。",
                "view": "back"
            },
            {
                "x": 115,
    ...
    "volleyball": {
        ...
        "points": [
            ...
            },
            {
                ...
                "y": 80,
                "name": "鎖骨下周囲 (右)",
                "desc": "鎖骨の外側1/3のすぐ下にあるくぼみ（指2〜3本分外側）。スパイクテイクバック時の胸郭のしなりと腕の引き込み。",
                "view": "front"
            },
            {
                "x": 118,
    ...
    "badminton": {
        ...
        "points": [
            ...
            },
            {
                ...
                "y": 80,
                "name": "鎖骨下周囲 (右)",
                "desc": "鎖骨の外側1/3のすぐ下にあるくぼみ（指2〜3本分外側）。背面のテンションを緩め、高い打点からのスマッシュ胸郭確保。",
                "view": "front"
            },
            {
                "x": 118,
            ...
            },
            {
                ...
                "y": 138,
                "name": "外側上顆周囲 (右)",
                "desc": "肘の外側の骨の出っ張り（外側上顆）から指1.5本分前腕（手首）寄りの筋肉 of ふくらみ。高速フリックによるラケット肘の疲労対策。",
                "view": "front"
            },
            {
                "x": 153,
    ...
    "tabletennis": {
        ...
        "points": [
            ...
            },
            {
                ...
                "y": 181,
                "name": "手関節背側 (右)",
                "desc": "手首の甲側のしわの中央から指1.5本分肘寄り、骨の間のくぼみ。手首の精緻なラケット面調整と、チキータ・ドライブ打球精度。",
                "view": "front"
            },
            {
                "x": 160,
    ...
    "judo": {
        ...
        "points": [
            ...
            },
            {
                ...
                "y": 170,
                "name": "前腕屈筋群 (右)",
                "desc": "肘の内側の骨の出っ張りから指3本分下、前腕の親指側寄りの筋肉 of ふくらみ。道着を強力にホールドする掴み手の握力持久。",
                "view": "front"
            },
            {
                "x": 148,
    ...
    "handball": {
        ...
        "points": [
            ...
            },
            {
                ...
                "y": 80,
                "name": "鎖骨下周囲 (右)",
                "desc": "鎖骨の外側1/3のすぐ下にあるくぼみ（指2〜3本分外側）。キャッチ・シュートにおける肩甲胸郭関節の回旋リリース。",
                "view": "front"
            },
            {
                "x": 118,
    ...
    "figureskating": {
        ...
        "points": [
            ...
            },
            {
                ...
                "y": 188,
                "name": "多裂筋起始部 (右)",
                "desc": "腰の背骨（腰椎）の突起のすぐきわ（指半本分外側）、仙骨のすぐ上。スピンやスパイラル姿勢の維持に必要な深層体幹の極小のコントロール。",
                "view": "back"
            },
            {
                "x": 113,
        ...
        "points": [
            {
                ...
                "y": 80,
                "name": "鎖骨下周囲 (右)",
                "desc": "鎖骨の外側1/3のすぐ下にあるくぼみ（指2〜3本分外側）。胸・肩の独立した動き（アイソレーション）の可動制限解除。",
                "view": "front"
            },
            {
                "x": 118,
...
const SYMPTOMS_MAPPING = {
    shoulder_stiff: {
        ...
        points: [
            ...
            { x: 110, y: 110, name: "肩甲間部 (Th3-Th4レベル) (左)", desc: "背骨の中心と肩甲骨の内側縁 of ちょうど中間、上から指3本分下がった高さ。肩甲骨の位置アライメントを正常化。", view: "back" },
    ...
    back_pain: {
        ...
        points: [
            ...
            { x: 110, y: 160, name: "胸腰椎移行部 (left)", desc: "一番下の肋骨の高さ（第12胸椎）の背骨のきわから左右に指1.5本分外側。多裂筋・胸最長筋を活性化し腰部のアライメント修正。", view: "back" },
            { x: 82, y: 170, name: "腰方形筋 (QL) 周囲 (右)", desc: "一番下の肋骨（第12肋骨）と骨盤の骨の縁（腸骨稜）のちょうど中間、背骨から指4本分外側の脇腹。腰の側屈・回旋時の痛みを緩和。", view: "back" },
            { x: 118, y: 170, name: "腰方形筋 (QL) 周囲 (left)", desc: "一番下の肋骨（第12肋骨）と骨盤の骨の縁（腸骨稜）のちょうど中間、背骨から指4本分外側の脇腹。腰の側屈・回旋時の痛みを緩和。", view: "back" },
